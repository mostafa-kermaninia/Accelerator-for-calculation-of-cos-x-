...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV GX" ENABLE_RUNTIME_MOD="NO" INIT_FILE="sin.mif" NUMWORDS_A=16 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=4 address_a clock0 q_a
...
`endif
	...
	defparam
		...
		ram_block1a_0.mem_init0 = 16'h5E15,
	...
	defparam
		...
		ram_block1a_1.mem_init0 = 16'h3431,
	...
	defparam
		...
		ram_block1a_2.mem_init0 = 16'h0D45,
	...
	defparam
		...
		ram_block1a_3.mem_init0 = 16'h0321,
	...
	defparam
		...
		ram_block1a_4.mem_init0 = 16'hFF15,
	...
	defparam
		...
		ram_block1a_5.mem_init0 = 16'h00F1,
	...
	defparam
		...
		ram_block1a_6.mem_init0 = 16'h000D,
	...
	defparam
		...
		ram_block1a_7.mem_init0 = 16'h0003,
...
`endif
	...
	ROM2_altsyncram	ROM2_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
